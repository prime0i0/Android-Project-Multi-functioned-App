    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(life <= 0)
                {
                    Toast.makeText(fourthree.this, "GAME OVER", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(fourthree.this , result.class);
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i1 = new Intent(fourthree.this , result.class);
                startActivity(i1);
                finish();
            }
        });
        b4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i2 = new Intent(fourthree.this , four.class);
                startActivity(i2);
                finish();
            }
        });
