...
public class fourone extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            if(life <= 0)
                {
                    Toast.makeText(fourone.this, "GAME OVER", Toast.LENGTH_SHORT).show();
                    Intent intent1 = new Intent(fourone.this , result.class);
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i1 = new Intent(fourone.this , result.class);
                startActivity(i1);
                finish();
            }
        });
        b4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i2 = new Intent(fourone.this , four.class);
                startActivity(i2);
                finish();
            }
        });
